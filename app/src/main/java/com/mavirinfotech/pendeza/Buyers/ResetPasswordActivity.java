...
public class ResetPasswordActivity extends AppCompatActivity
{
    ...
    protected void onStart()
    {
        ...
        if (check.equals("settings"))
        {
            ...
            titleQuestion.setText("Please set answeres for the following security questions");
            ...
            ref.child("Security Questions").updateChildren(userdatamap)
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task)
                        {
                            ...
                            {
                                Toast.makeText(ResetPasswordActivity.this, "Security Questions Answered Successfully", Toast.LENGTH_SHORT).show();
